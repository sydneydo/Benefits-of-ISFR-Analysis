...
Sleep = ActivityImpl('Sleep',0,8,Loft);          % Sleep period
...
% Lab (PEM) CCAA
LabCCAA = ISSDehumidifierImpl(Lab,DirtyWaterStore,MainPowerStore);

% Loft CCAA
LoftCCAA = ISSDehumidifierImpl(Loft,DirtyWaterStore,MainPowerStore);

% PCM CCAA
PCMCCAA = ISSDehumidifierImpl(PCM,DirtyWaterStore,MainPowerStore);

% Suitlock
SuitlockCCAA = ISSDehumidifierImpl(Suitlock,DirtyWaterStore,MainPowerStore);
...
% CO2 molar fraction
figure, 
subplot(2,2,1), plot(t,LabCO2level(t)./LabTotalMoles(t),'LineWidth',2), title('Inflatable 1'), grid on, xlabel('Time (hours)'), ylabel('CO2 Molar Fraction')
subplot(2,2,2), plot(t,PCMCO2level(t)./PCMTotalMoles(t),'LineWidth',2), title('Living Unit 1'), grid on, xlabel('Time (hours)'), ylabel('CO2 Molar Fraction')
...
subplot(2,2,4), plot(t,PLMCO2level(t)./PLMTotalMoles(t),'LineWidth',2), title('Cargo Unit 1'), grid on, xlabel('Time (hours)'), ylabel('CO2 Molar Fraction')

% CO2 Partial Pressure
figure, 
subplot(2,2,1), plot(t,LabCO2level(t)./LabTotalMoles(t).*LabPressure(t),'LineWidth',2), title('Inflatable 1'), grid on, xlabel('Time (hours)'), ylabel('CO2 Partial Pressure')
subplot(2,2,2), plot(t,PCMCO2level(t)./PCMTotalMoles(t).*PCMPressure(t),'LineWidth',2), title('Living Unit 1'), grid on, xlabel('Time (hours)'), ylabel('CO2 Partial Pressure')
...
subplot(2,2,4), plot(t,PLMCO2level(t)./PLMTotalMoles(t).*PLMPressure(t),'LineWidth',2), title('Cargo Unit 1'), grid on, xlabel('Time (hours)'), ylabel('CO2 Partial Pressure')

subplot(2,2,3),line([1 length(t)],0.482633011*ones(1,2),'LineWidth',2,'Color','r')

figure, 
plot(t,PLMCO2level(t)./PLMTotalMoles(t).*PLMPressure(t),'LineWidth',1), 
